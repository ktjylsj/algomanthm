...
(function (global, factory) {
  ...
  function transformer() {
    ...
    scale.domain = function(_) {
      return arguments.length ? (domain = map$3.call(_, number$3), clamp === identity$4 || (clamp = clamper(domain)), rescale()) : domain.slice();
    };
  ...
  function continuous$1(deinterpolate, reinterpolate) {
    ...
    scale.domain = function(_) {
      return arguments.length ? (domain = map$5.call(_, number$6), rescale()) : domain.slice();
    };
  ...
  var TimeOverview = Kapsule({
    ...
    init: function init(el, state) {
      ...
      state.brush = brushX().on('end', function () {
        ...
        state.onChange.apply(state, _toConsumableArray(selection$$1));
      }); // Build dom
