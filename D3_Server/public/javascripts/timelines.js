    ...
    !function(e, t) {
        ...
        !function(e, t) {
            ...
            if (e && "undefined" != typeof document) {
                ...
                r.type = "text/css",
                "top" === n && a.firstChild ? a.insertBefore(r, a.firstChild) : a.appendChild(r),
        ...
        var n, a = t(function(e, t) {
            ...
            e.exports = function(e) {
                    ...
                    t.default = function(e) {
                        ...
                        return function() {
                            ...
                            Object.keys(u).forEach(function(e) {
                                a[e] = function() {
                                    for (var n, r = arguments.length, i = Array(r), f = 0; f < r; f++)
                                        i[f] = arguments[f];
                        ...
                        if (Symbol.iterator in Object(e))
                            return function(e, t) {
                                var n = []
                                  ...
                                  , i = void 0;
                                try {
                                    for (var f, c = e[Symbol.iterator](); !(a = (f = c.next()).done) && (n.push(f.value),
                                    !t || n.length !== t); a = !0)
                                        ;
                                } catch (e) {
                                    r = !0,
                ...
                ,
                r = [e, t, n(1)],
                void 0 === (i = "function" == typeof (a = f) ? a.apply(t, r) : a) || (e.exports = i)
            }
            , function(e, t) {
                e.exports = function(e, t, n) {
                    ...
                    function o() {
                        var u = Date.now() - f;
                        u < t && u >= 0 ? a = setTimeout(o, t - u) : (a = null,
                        n || (c = e.apply(i, r),
                        i = r = null))
                    }
                    null == t && (t = 100);
        ...
        function o(e, t) {
            ...
            if (void 0 === t)
                for (let t of e)
                    null != t && t >= t && (void 0 === n || n < t) && (n = t);
            else {
                let a = -1;
                for (let r of e)
                    null != (r = t(r, ++a, e)) && r >= r && (void 0 === n || n < r) && (n = r)
            }
            return n
        }
        function u(e, t) {
        ...
        function w(e, t) {
            ...
            function x(l) {
                ...
                D = D.merge(z),
                N = N.merge(z.append("line").attr("stroke", "currentColor").attr(u + "2", o * i)),
                F = F.merge(z.append("text").attr("fill", "currentColor").attr(u, o * x).attr("dy", e === d ? "0em" : e === b ? "0.71em" : "0.32em")).on("mouseover",function(){
                    d3.select(this).attr("font-size","20px").style("fill","red");
                }).on("mouseout",function(){
                    d3.select(this).attr("font-size","10").style("fill","black");
                }),
                l !== k && (T = T.transition(l),
                D = D.transition(l),
                N = N.transition(l),
                F = F.transition(l),
                C = C.transition(l).attr("opacity", p).attr("transform", function(e) {
                ...
                C.remove(),
                T.attr("d", e === g || e == h ? f ? "M" + o * f + "," + M + "H0.5V" + A + "H" + o * f : "M0.5," + M + "V" + A : f ? "M" + M + "," + o * f + "V0.5H" + A + "V" + o * f : "M" + M + ",0.5H" + A),
                D.attr("opacity", 1).attr("transform", function(e) {
                    return w(S(e))
                }),
                N.attr(u + "2", o * i),
                F.attr(u, o * x).text(v),
                k.filter(y).attr("fill", "none").attr("font-size", 10).attr("font-family", "sans-serif").attr("text-anchor", e === h ? "start" : e === g ? "end" : "middle"),
                k.each(function() {
                    this.__axis = S
                })
            }
            ...
            ,
            x.ticks = function() {
                return n = l.call(arguments),
                x
            }
            ,
            x.tickArguments = function(e) {
                return arguments.length ? (n = null == e ? [] : l.call(e),
                x) : n.slice()
            }
            ,
            x.tickValues = function(e) {
                return arguments.length ? (a = null == e ? null : l.call(e),
                x) : a && a.slice()
            }
            ,
        ...
        function C(e, t, n) {
            var a = Math.abs(t - e) / Math.max(0, n)
              ...
              , i = a / r;
            return i >= S ? r *= 10 : i >= k ? r *= 5 : i >= T && (r *= 2),
            t < e ? -r : r
        }
        function z(e, t) {
        ...
        function P() {
            ...
            return r.domain = function(n) {
                ...
                t = [],
                e = F();
                for (var a, i, f = -1, c = n.length; ++f < c; )
                    e.has(i = (a = n[f]) + "") || e.set(i, t.push(a));
                return r
            }
            ,
            r.range = function(e) {
                return arguments.length ? (n = E.call(e),
                r) : n.slice()
            }
            ,
        ...
        function O() {
            var e, t, n = P().unknown(void 0), a = n.domain, r = n.range, i = [0, 1], f = !1, c = 0, o = 0, u = .5;
            function l() {
                var n = a().length
                  , l = i[1] < i[0]
                  , s = i[l - 0]
                  , d = i[1 - l];
                e = (d - s) / Math.max(1, n - c + 2 * o),
                f && (e = Math.floor(e)),
                s += (d - s - e * (n - c)) * u,
                t = e * (1 - c),
                f && (s = Math.round(s),
                ...
                var h = function(e, t, n) {
                    e = +e,
                    t = +t,
                    n = (r = arguments.length) < 2 ? (t = e,
                    e = 0,
                    1) : r < 3 ? 1 : +n;
                    for (var a = -1, r = 0 | Math.max(0, Math.ceil((t - e) / n)), i = new Array(r); ++a < r; )
                        i[a] = e + a * n;
                    return i
                }(n).map(function(t) {
                    return s + e * t
            ...
            ,
            n.range = function(e) {
                return arguments.length ? (i = [+e[0], +e[1]],
                l()) : i.slice()
            }
            ,
            ...
            n.padding = function(e) {
                return arguments.length ? (c = Math.min(1, o = +e),
                l()) : c
            }
            ,
            n.paddingInner = function(e) {
                return arguments.length ? (c = Math.min(1, e),
                l()) : c
            }
            ,
            ...
            ,
            n.align = function(e) {
                return arguments.length ? (u = Math.max(0, Math.min(1, e)),
                l()) : u
            }
            ,
            n.copy = function() {
        ...
        function fe(e) {
            return e instanceof q || (e = ae(e)),
            e ? new oe((e = e.rgb()).r,e.g,e.b,e.opacity) : new oe
        }
        function ce(e, t, n, a) {
        ...
        X(se, function(e, t, n, a) {
            return 1 === arguments.length ? function(e) {
                ...
                var t = (e = e.rgb()).r / 255
                  ...
                  , c = i - r
                  , o = (i + r) / 2;
                return c ? (f = t === i ? (n - a) / c + 6 * (n < a) : n === i ? (a - t) / c + 2 : (t - n) / c + 4,
                c /= o < .5 ? i + r : 2 - i - r,
                f *= 60) : c = o > 0 && o < 1 ? 0 : f,
                new se(f,c,o,e.opacity)
            }(e) : new se(e,t,n,null == a ? 1 : a)
        }, j(q, {
            brighter: function(e) {
                return e = null == e ? 1 / .7 : Math.pow(1 / .7, e),
                new se(this.h,this.s,this.l * e,this.opacity)
            },
            darker: function(e) {
                return e = null == e ? .7 : Math.pow(.7, e),
                new se(this.h,this.s,this.l * e,this.opacity)
        ...
        function _e(e) {
            if (e instanceof Me)
                return new Me(e.l,e.a,e.b,e.opacity);
            if (e instanceof De) {
                if (isNaN(e.h))
                    return new Me(e.l,0,0,e.opacity);
                var t = e.h * he;
                return new Me(e.l,Math.cos(t) * e.c,Math.sin(t) * e.c,e.opacity)
            }
            e instanceof oe || (e = fe(e));
            var n, a, r = Te(e.r), i = Te(e.g), f = Te(e.b), c = Ae((.2225045 * r + .7168786 * i + .0606169 * f) / pe);
            return r === i && i === f ? n = a = c : (n = Ae((.4360747 * r + .3850649 * i + .1430804 * f) / ge),
            a = Ae((.0139322 * r + .0971045 * i + .7141733 * f) / me)),
            new Me(116 * c - 16,500 * (n - c),200 * (c - a),e.opacity)
        }
        function Me(e, t, n, a) {
            this.l = +e,
            this.a = +t,
        ...
        X(De, function(e, t, n, a) {
            return 1 === arguments.length ? function(e) {
                if (e instanceof De)
                    return new De(e.h,e.c,e.l,e.opacity);
                if (e instanceof Me || (e = _e(e)),
                0 === e.a && 0 === e.b)
                    return new De(NaN,0,e.l,e.opacity);
        ...
        ,
        function(e) {
            var t, n, a = e.length, r = new Array(a), i = new Array(a), f = new Array(a);
            for (t = 0; t < a; ++t)
                n = ce(e[t]),
                r[t] = n.r || 0,
                i[t] = n.g || 0,
        ...
        function Ge(e, t) {
            var n, a, r, i = Be.lastIndex = $e.lastIndex = 0, f = -1, c = [], o = [];
            for (e += "",
            t += ""; (n = Be.exec(e)) && (a = $e.exec(t)); )
                (r = a.index) > i && (r = t.slice(i, r),
                c[f] ? c[f] += r : c[++f] = r),
                (n = n[0]) === (a = a[0]) ? c[f] ? c[f] += a : c[++f] = a : (c[++f] = null,
                o.push({
                    i: f,
                    x: We(n, a)
                })),
                i = $e.lastIndex;
            return i < t.length && (r = t.slice(i),
            c[f] ? c[f] += r : c[++f] = r),
            c.length < 2 ? o[0] ? function(e) {
                return function(t) {
                    return e(t) + ""
                }
            }(o[0].x) : function(e) {
        ...
        function Ze(e, t) {
            var n, a = typeof t;
            return null == t || "boolean" === a ? Pe(t) : ("number" === a ? We : "string" === a ? (n = ae(t)) ? (t = n,
            je) : Ge : t instanceof ae ? je : t instanceof Date ? function(e, t) {
                var n = new Date;
                return t -= e = +e,
                function(a) {
                    return n.setTime(e + t * a),
                    n
                }
            }
            : Array.isArray(t) ? function(e, t) {
                var n, a = t ? t.length : 0, r = e ? Math.min(a, e.length) : 0, i = new Array(r), f = new Array(a);
                for (n = 0; n < r; ++n)
                    i[n] = Ze(e[n], t[n]);
                for (; n < a; ++n)
                    f[n] = t[n];
        ...
        var Je, Ke, et, tt, nt = 180 / Math.PI, at = {
            translateX: 0,
            translateY: 0,
            rotate: 0,
            skewX: 0,
        ...
        function rt(e, t, n, a, r, i) {
            var f, c, o;
            return (f = Math.sqrt(e * e + t * t)) && (e /= f,
            t /= f),
            (o = e * n + t * a) && (n -= e * o,
            a -= t * o),
            (c = Math.sqrt(n * n + a * a)) && (n /= c,
            a /= c,
            o /= c),
            e * a < t * n && (e = -e,
            t = -t,
            ...
            return function(i, f) {
                ...
                function(e, t, n, a, i, f) {
                    if (e !== n || t !== a) {
                        ...
                        1 === n && 1 === a || i.push(r(i) + "scale(" + n + "," + a + ")")
                }(i.scaleX, i.scaleY, f.scaleX, f.scaleY, c, o),
                i = f = null,
                function(e) {
                    for (var t, n = -1, a = o.length; ++n < a; )
                        c[(t = o[n]).i] = t.x(e);
                    return c.join("")
                }
            }
        ...
        var ft = it(function(e) {
            return "none" === e ? at : (Je || (Je = document.createElement("DIV"),
            Ke = document.documentElement,
            et = document.defaultView),
            Je.style.transform = e,
            e = et.getComputedStyle(Ke.appendChild(Je), null).getPropertyValue("transform"),
            Ke.removeChild(Je),
            rt(+(e = e.slice(7, -1).split(","))[0], +e[1], +e[2], +e[3], +e[4], +e[5]))
        }, "px, ", "px)", "deg)")
          , ct = it(function(e) {
            return null == e ? at : (tt || (tt = document.createElementNS("http://www.w3.org/2000/svg", "g")),
            tt.setAttribute("transform", e),
            (e = tt.transform.baseVal.consolidate()) ? rt((e = e.matrix).a, e.b, e.c, e.d, e.e, e.f) : at)
        }, ", ", ")", ")");
        Math.SQRT2;
        function ot(e) {
            return function t(n) {
        ...
        function vt(e, t) {
            return function() {
                var e, t, n, a, r, i, f = st, c = st, o = Ze, u = dt;
                function l() {
                    return a = Math.min(f.length, c.length) > 2 ? pt : gt,
                    r = i = null,
                    s
                }
                function s(t) {
                ...
                ,
                s.domain = function(e) {
                    return arguments.length ? (f = U.call(e, lt),
                    u === dt || (u = bt(f)),
                    l()) : f.slice()
                }
                ,
                s.range = function(e) {
                    return arguments.length ? (c = E.call(e),
                    l()) : c.slice()
                }
                ,
                ...
                ,
                s.clamp = function(e) {
                    return arguments.length ? (u = e ? bt(f) : dt,
                    s) : u !== dt
                }
                ,
        ...
        function Ft(e) {
            var t, n, a = e.grouping && e.thousands ? (t = e.grouping,
            n = e.thousands,
            function(e, a) {
                for (var r = e.length, i = [], f = 0, c = t[0], o = 0; r > 0 && c > 0 && (o + c + 1 > a && (c = Math.max(1, a - o)),
                i.push(e.substring(r -= c, r + c)),
                !((o += c + 1) > a)); )
                    c = t[f = (f + 1) % t.length];
                return i.reverse().join(n)
            }
            ) : Tt, r = e.currency, i = e.decimal, f = e.numerals ? function(e) {
                return function(t) {
                    return t.replace(/[0-9]/g, function(t) {
                        return e[+t]
                    })
                }
            }(e.numerals) : Tt, c = e.percent || "%";
            function o(e) {
                var t = (e = Mt(e)).fill
                  , n = e.align
                  , o = e.sign
                ...
                function w(e) {
                    ...
                    if ("c" === g)
                        ...
                        if (e = v(Math.abs(e), h),
                        b && (e = function(e) {
                            e: for (var t, n = e.length, a = 1, r = -1; a < n; ++a)
                                switch (e[a]) {
                                case ".":
                                    r = t = a;
                                    break;
                        ...
                        _ && 0 == +e && (_ = !1),
                        w = (_ ? "(" === o ? o : "-" : "-" === o || "(" === o ? "" : o) + w,
                        x = ("s" === g ? Nt[8 + xt / 3] : "") + x + (_ && "(" === o ? ")" : ""),
                        y)
                            for (r = -1,
                            c = e.length; ++r < c; )
                                if (48 > (u = e.charCodeAt(r)) || u > 57) {
                                    x = (46 === u ? i + e.slice(r + 1) : e.slice(r)) + x,
                                    e = e.slice(0, r);
                                    break
                                }
                    }
                    ...
                    switch (d && l && (e = a(A + e, A.length ? s - x.length : 1 / 0),
                    A = ""),
                    n) {
                    case "<":
                        e = w + e + x + A;
                ...
                return h = null == h ? 6 : /[gprs]/.test(g) ? Math.max(1, Math.min(21, h)) : Math.max(0, Math.min(20, h)),
                w.toString = function() {
                    return e + ""
                }
                ,
        ...
        function Ut(e) {
            ...
            return e.ticks = function(e) {
                ...
                return function(e, t, n) {
                    ...
                    e = t,
                    t = r),
                    0 === (f = D(e, t, n)) || !isFinite(f))
                        return [];
                    if (f > 0)
                        for (e = Math.ceil(e / f),
                        t = Math.floor(t / f),
                        i = new Array(r = Math.ceil(t - e + 1)); ++c < r; )
                            i[c] = (e + c) * f;
                    else
                        for (e = Math.floor(e * f),
                        t = Math.ceil(t * f),
                        i = new Array(r = Math.ceil(e - t + 1)); ++c < r; )
                            i[c] = (e - c) / f;
                    return a && i.reverse(),
                    i
            ...
            e.tickFormat = function(e, n) {
                ...
                return function(e, t, n, a) {
                    ...
                    case "s":
                        ...
                        return null != a.precision || isNaN(r = Lt(i, f)) || (a.precision = r),
                        zt(a, f);
                    case "":
                    case "e":
                    case "g":
            ...
            e.nice = function(n) {
                null == n && (n = 10);
                var a, r = t(), i = 0, f = r.length - 1, c = r[i], o = r[f];
                return o < c && (a = c,
                c = o,
                o = a,
                a = i,
                i = f,
                f = a),
                (a = D(c, o, n)) > 0 ? a = D(c = Math.floor(c / a) * a, o = Math.ceil(o / a) * a, n) : a < 0 && (a = D(c = Math.ceil(c * a) / a, o = Math.floor(o * a) / a, n)),
                a > 0 ? (r[i] = Math.floor(c / a) * a,
                r[f] = Math.ceil(o / a) * a,
                t(r)) : a < 0 && (r[i] = Math.ceil(c * a) / a,
                r[f] = Math.floor(o * a) / a,
                t(r)),
                e
            }
            ,
        ...
        function Pt(e, t, n, a) {
            ...
            r.every = function(e) {
                ...
                isFinite(e) && e > 0 ? e > 1 ? r.filter(a ? function(t) {
                    return a(t) % e == 0
                }
                : function(t) {
        ...
        Ot.every = function(e) {
            return e = Math.floor(e),
            isFinite(e) && e > 0 ? e > 1 ? Pt(function(t) {
        ...
        Pt(function(e) {
            ...
            t < 0 && (t += 36e5),
            e.setTime(36e5 * Math.floor((+e - t) / 36e5) + t)
        }, function(e, t) {
            e.setTime(+e + 36e5 * t)
        }, function(e, t) {
            return (t - e) / 36e5
        ...
        function zn(e, t, n) {
            var a = mn.exec(t.slice(n, n + 2));
            return a ? (e.y = +a[0] + (+a[0] > 68 ? 1900 : 2e3),
            n + a[0].length) : -1
        }
        function Nn(e, t, n) {
            var a = /^(Z)|([+-]\d\d)(?::?(\d\d))?/.exec(t.slice(n, n + 6));
            return a ? (e.Z = a[1] ? 0 : -(a[2] + (a[3] || "00")),
            n + a[0].length) : -1
        }
        function Fn(e, t, n) {
            var a = mn.exec(t.slice(n, n + 2));
        ...
        function Pn(e, t, n) {
            ...
            return a ? (e.L = Math.floor(a[0] / 1e3),
            n + a[0].length) : -1
        }
        function On(e, t, n) {
        ...
        function ea(e, t) {
            var n = e.getDay();
            return e = n >= 4 || 0 === n ? Zt(e) : Zt.ceil(e),
            wn(Zt.count(Jt(e), e) + (4 === Jt(e).getDay()), t, 2)
        }
        function ta(e) {
            return e.getDay()
        }
        ...
        function ma(e, t) {
            var n = e.getUTCDay();
            return e = n >= 4 || 0 === n ? fn(e) : fn.ceil(e),
            wn(fn.count(on(e), e) + (4 === on(e).getUTCDay()), t, 2)
        }
        function va(e) {
            return e.getUTCDay()
        }
        ...
        !function(e) {
            dn = function(e) {
                var t = e.dateTime
                  ...
                  , x = {
                    a: function(e, t, n) {
                        ...
                        return a ? (e.w = b[a[0].toLowerCase()],
                        n + a[0].length) : -1
                    },
                    A: function(e, t, n) {
                        var a = s.exec(t.slice(n));
                        return a ? (e.w = d[a[0].toLowerCase()],
                        n + a[0].length) : -1
                    },
                    b: function(e, t, n) {
                        var a = m.exec(t.slice(n));
                        return a ? (e.m = v[a[0].toLowerCase()],
                        n + a[0].length) : -1
                    },
                    B: function(e, t, n) {
                        var a = g.exec(t.slice(n));
                        return a ? (e.m = p[a[0].toLowerCase()],
                        n + a[0].length) : -1
                    },
                    c: function(e, n, a) {
                        return A(e, t, n, a)
                    ...
                    p: function(e, t, n) {
                        ...
                        return a ? (e.p = l[a[0].toLowerCase()],
                        n + a[0].length) : -1
                    },
                    Q: In,
                    s: Xn,
                ...
                function _(e, t) {
                    return function(n) {
                        var a, r, i, f = [], c = -1, o = 0, u = e.length;
                        for (n instanceof Date || (n = new Date(+n)); ++c < u; )
                            37 === e.charCodeAt(c) && (f.push(e.slice(o, c)),
                            null != (r = pn[a = e.charAt(++c)]) ? a = e.charAt(++c) : r = "e" === a ? " " : "0",
                            (i = t[a]) && (a = i(n, r)),
                            f.push(a),
                            o = c + 1);
                        return f.push(e.slice(o, c)),
                        f.join("")
                    }
                }
                function M(e, t) {
                    return function(n) {
                        ...
                        "V"in i) {
                            if (i.V < 1 || i.V > 53)
                                return null;
                            "w"in i || (i.w = 1),
                            "Z"in i ? (r = (a = ln(sn(i.y))).getUTCDay(),
                            a = r > 4 || 0 === r ? rn.ceil(a) : rn(a),
                            a = tn.offset(a, 7 * (i.V - 1)),
                            i.y = a.getUTCFullYear(),
                            i.m = a.getUTCMonth(),
                            i.d = a.getUTCDate() + (i.w + 6) % 7) : (r = (a = t(sn(i.y))).getDay(),
                            a = r > 4 || 0 === r ? Gt.ceil(a) : Gt(a),
                            a = Wt.offset(a, 7 * (i.V - 1)),
                            i.y = a.getFullYear(),
                            i.m = a.getMonth(),
                            i.d = a.getDate() + (i.w + 6) % 7)
                        } else
                            ("W"in i || "U"in i) && ("w"in i || (i.w = "u"in i ? i.u % 7 : "W"in i ? 1 : 0),
                            r = "Z"in i ? ln(sn(i.y)).getUTCDay() : t(sn(i.y)).getDay(),
                            i.m = 0,
                            i.d = "W"in i ? (i.w + 6) % 7 + 7 * i.W - (r + 5) % 7 : i.w + 7 * i.U - (r + 6) % 7);
                ...
                function A(e, t, n, a) {
                    for (var r, i, f = 0, c = t.length, o = n.length; f < c; ) {
                        ...
                        if (37 === (r = t.charCodeAt(f++))) {
                            if (r = t.charAt(f++),
                            !(i = x[r in pn ? t.charAt(f++) : r]) || (a = i(e, n, a)) < 0)
                                return -1
                        } else if (r != n.charCodeAt(a++))
                            return -1
                    }
                    return a
                }
        ...
        Date.prototype.toISOString || bn("%Y-%m-%dT%H:%M:%S.%LZ");
        +new Date("2000-01-01T00:00:00.000Z") || gn("%Y-%m-%dT%H:%M:%S.%LZ");
        var ka = 1e3
          , Ta = 60 * ka
          , Da = 60 * Ta
          , Ca = 24 * Da
        ...
        function Ra(e, t, n, a, r, i, f, c, o) {
            var u = vt(dt, dt)
              ...
              , v = o("%B")
              , y = o("%Y")
              , w = [[f, 1, ka], [f, 5, 5 * ka], [f, 15, 15 * ka], [f, 30, 30 * ka], [i, 1, Ta], [i, 5, 5 * Ta], [i, 15, 15 * Ta], [i, 30, 30 * Ta], [r, 1, Da], [r, 3, 3 * Da], [r, 6, 6 * Da], [r, 12, 12 * Da], [a, 1, Ca], [a, 2, 2 * Ca], [n, 1, za], [t, 1, Na], [t, 3, 3 * Na], [e, 1, Fa]];
            function x(c) {
            ...
            function _(t, n, a, r) {
                ...
                "number" == typeof t) {
                    ...
                    f === w.length ? (r = C(n / Fa, a / Fa, t),
                    t = e) : f ? (r = (f = w[i / w[f - 1][2] < w[f][2] / i ? f - 1 : f])[1],
                    t = f[0]) : (r = Math.max(C(n, a, t), 1),
                    t = c)
                }
            ...
            u.ticks = function(e, t) {
                var n, a = s(), r = a[0], i = a[a.length - 1], f = i < r;
                return f && (n = r,
                r = i,
                i = n),
                n = (n = _(e, r, i, t)) ? n.range(r, i + 1) : [],
                f ? n.reverse() : n
            }
            ,
            ...
            u.nice = function(e, t) {
                ...
                return (e = _(e, n[0], n[n.length - 1], t)) ? s(function(e, t) {
                    var n, a = 0, r = (e = e.slice()).length - 1, i = e[a], f = e[r];
                    return f < i && (n = a,
                    a = r,
                    r = n,
                    n = i,
        ...
        function Ua() {
            var e = Ut(function() {
                var e, t, n, a, r, i = 0, f = 1, c = dt, o = !1;
                function u(t) {
                    return isNaN(t = +t) ? r : c(0 === n ? .5 : (t = (a(t) - e) * n,
                    o ? Math.max(0, Math.min(1, t)) : t))
                }
                return u.domain = function(r) {
                    return arguments.length ? (e = a(i = +r[0]),
                    t = a(f = +r[1]),
                    n = e === t ? 0 : 1 / (t - e),
                    u) : [i, f]
                }
            ...
            return e.copy = function() {
                return t = e,
                Ua().domain(t.domain()).interpolator(t.interpolator()).clamp(t.clamp()).unknown(t.unknown());
                var t
            }
            ,
            function(e, t) {
        ...
        function Ga(e, t, n, a, r, i) {
            for (var f, c = 0, o = t.length, u = i.length; c < u; ++c)
                (f = t[c]) ? (f.__data__ = i[c],
                a[c] = f) : n[c] = new Ba(e,i[c]);
            for (; c < o; ++c)
                (f = t[c]) && (r[c] = f)
        }
        function Za(e, t, n, a, r, i, f) {
            ...
            for (c = 0; c < s; ++c)
                (o = t[c]) && (h[c] = u = $a + f.call(o, o.__data__, c, t),
                u in l ? r[c] = o : l[u] = o);
            for (c = 0; c < d; ++c)
                (o = l[u = $a + f.call(e, i[c], c, i)]) ? (a[c] = o,
                o.__data__ = i[c],
                l[u] = null) : n[c] = new Ba(e,i[c]);
            for (c = 0; c < s; ++c)
                (o = t[c]) && l[h[c]] === o && (r[c] = o)
        }
        function Qa(e, t) {
        ...
        function nr(e) {
            this._node = e,
            this._names = er(e.getAttribute("class") || "")
        }
        function ar(e, t) {
            for (var n = tr(e), a = -1, r = t.length; ++a < r; )
                n.add(t[a])
        }
        function rr(e, t) {
            for (var n = tr(e), a = -1, r = t.length; ++a < r; )
        ...
        function mr(e) {
            return function() {
                var t = this.__on;
                if (t) {
                    for (var n, a = 0, r = -1, i = t.length; a < i; ++a)
                        n = t[a],
                        e.type && n.type !== e.type || n.name !== e.name ? t[++r] = n : this.removeEventListener(n.type, n.listener, n.capture);
        ...
        function vr(e, t, n) {
            ...
            return function(r, i, f) {
                var c, o = this.__on, u = a(t, i, f);
                if (o)
                    for (var l = 0, s = o.length; l < s; ++l)
                        if ((c = o[l]).type === e.type && c.name === e.name)
                            return this.removeEventListener(c.type, c.listener, c.capture),
                            this.addEventListener(c.type, c.listener = u, c.capture = n),
                            void (c.value = t);
        ...
        function yr(e, t, n) {
            var a = Ja(e)
              , r = a.CustomEvent;
            "function" == typeof r ? r = new r(t,n) : (r = a.document.createEvent("Event"),
            n ? (r.initEvent(t, n.bubbles, n.cancelable),
            r.detail = n.detail) : r.initEvent(t, !1, !1)),
            e.dispatchEvent(r)
        }
        var wr = [null];
        function xr(e, t) {
        ...
        function _r() {
            return new xr([[document.documentElement]],wr)
        }
        function Mr(e) {
            return "string" == typeof e ? new xr([[document.querySelector(e)]],[document.documentElement]) : new xr([[e]],wr)
        }
        function Ar() {
            for (var e, t = br; e = t.sourceEvent; )
                t = e;
            return t
        }
        function Sr(e) {
            ...
            function(e, t) {
                ...
                if (n.createSVGPoint) {
                    ...
                    return a.x = t.clientX,
                    a.y = t.clientY,
                    [(a = a.matrixTransform(e.getScreenCTM().inverse())).x, a.y]
                }
        ...
        function kr() {
            ...
            function o(e) {
                var t;
                t = e.node(),
                (i = t ? "svg" === t.tagName.toLowerCase() ? t : t.ownerSVGElement : null) && (f = i.createSVGPoint(),
                a.appendChild(r))
            }
            o.show = function() {
                var r = Array.prototype.slice.call(arguments);
                r[r.length - 1]instanceof SVGElement && (c = r.pop());
                var i, f = n.apply(this, r), s = t.apply(this, r), h = e.apply(this, r), b = d(), g = l.length, p = document.documentElement.scrollTop || a.scrollTop, m = document.documentElement.scrollLeft || a.scrollLeft;
                for (b.html(f).style("opacity", 1).style("pointer-events", "all"); g--; )
                    b.classed(l[g], !1);
                return i = u.get(h).apply(this),
                b.classed(h, !0).style("top", i.top + s[0] + p + "px").style("left", i.left + s[1] + m + "px"),
                o
            }
            ,
            o.hide = function() {
                return d().style("opacity", 0).style("pointer-events", "none"),
                o
            }
            ,
            o.attr = function(e, t) {
                ...
                return _r.prototype.attr.apply(d(), n),
                o
            }
            ,
            o.style = function(e, t) {
                if (arguments.length < 2 && "string" == typeof e)
                    return d().style(e);
                var n = Array.prototype.slice.call(arguments);
                return _r.prototype.style.apply(d(), n),
                o
            }
            ,
            o.direction = function(t) {
                return arguments.length ? (e = null == t ? t : b(t),
                o) : e
            }
            ,
            o.offset = function(e) {
                return arguments.length ? (t = null == e ? e : b(e),
                o) : t
            }
            ,
            o.html = function(e) {
                return arguments.length ? (n = null == e ? e : b(e),
                o) : n
            }
            ,
            o.rootElement = function(e) {
                return arguments.length ? (a = null == e ? e : b(e),
                o) : a
            }
            ,
            o.destroy = function() {
            ...
            function s() {
                ...
                return e.style("position", "absolute").style("top", 0).style("opacity", 0).style("pointer-events", "none").style("box-sizing", "border-box"),
                e.node()
            }
            function d() {
                return null == r && (r = s(),
            ...
            function h(e) {
                for (var t = c || e; null == t.getScreenCTM && null != t.parentNode; )
                    t = t.parentNode;
                var n = {}
                  , a = t.getScreenCTM()
                  , r = t.getBBox()
                ...
                return f.x = u,
                f.y = l,
                n.nw = f.matrixTransform(a),
                f.x += i,
                n.ne = f.matrixTransform(a),
                f.y += o,
                n.se = f.matrixTransform(a),
                f.x -= i,
                n.sw = f.matrixTransform(a),
                f.y -= o / 2,
                n.w = f.matrixTransform(a),
                f.x += i,
                n.e = f.matrixTransform(a),
                f.x -= i / 2,
                f.y -= o / 2,
                n.n = f.matrixTransform(a),
                f.y += o,
                n.s = f.matrixTransform(a),
                n
            }
            function b(e) {
        ...
        xr.prototype = _r.prototype = {
            ...
            select: function(e) {
                ...
                for (var t = this._groups, n = t.length, a = new Array(n), r = 0; r < n; ++r)
                    for (var i, f, c = t[r], o = c.length, u = a[r] = new Array(o), l = 0; l < o; ++l)
                        (i = c[l]) && (f = e.call(i, i.__data__, l, c)) && ("__data__"in i && (f.__data__ = i.__data__),
                        u[l] = f);
            ...
            selectAll: function(e) {
                ...
                for (var t = this._groups, n = t.length, a = [], r = [], i = 0; i < n; ++i)
                    for (var f, c = t[i], o = c.length, u = 0; u < o; ++u)
                        (f = c[u]) && (a.push(e.call(f, f.__data__, u, c)),
                        r.push(f));
                return new xr(a,r)
            },
            filter: function(e) {
                ...
                for (var t = this._groups, n = t.length, a = new Array(n), r = 0; r < n; ++r)
                    for (var i, f = t[r], c = f.length, o = a[r] = [], u = 0; u < c; ++u)
                        (i = f[u]) && e.call(i, i.__data__, u, f) && o.push(i);
                return new xr(a,this._parents)
            },
            data: function(e, t) {
                if (!e)
                    return b = new Array(this.size()),
                    l = -1,
                    this.each(function(e) {
                        b[++l] = e
                    }),
                    b;
                var n, a = t ? Za : Ga, r = this._parents, i = this._groups;
            ...
            join: function(e, t, n) {
                var a = this.enter()
                  , r = this
                  , i = this.exit();
                return a = "function" == typeof e ? e(a) : a.append(e + ""),
                null != t && (r = t(r)),
                null == n ? i.remove() : n(i),
                a && r ? a.merge(r).order() : r
            },
            merge: function(e) {
                for (var t = this._groups, n = e._groups, a = t.length, r = n.length, i = Math.min(a, r), f = new Array(a), c = 0; c < i; ++c)
                    for (var o, u = t[c], l = n[c], s = u.length, d = f[c] = new Array(s), h = 0; h < s; ++h)
                        (o = u[h] || l[h]) && (d[h] = o);
                for (; c < a; ++c)
                    f[c] = t[c];
            ...
            order: function() {
                for (var e = this._groups, t = -1, n = e.length; ++t < n; )
                    for (var a, r = e[t], i = r.length - 1, f = r[i]; --i >= 0; )
                        (a = r[i]) && (f && 4 ^ a.compareDocumentPosition(f) && f.parentNode.insertBefore(a, f),
                        f = a);
                return this
            },
            sort: function(e) {
                ...
                for (var n = this._groups, a = n.length, r = new Array(a), i = 0; i < a; ++i) {
                    for (var f, c = n[i], o = c.length, u = r[i] = new Array(o), l = 0; l < o; ++l)
                        (f = c[l]) && (u[l] = f);
                    u.sort(t)
                }
            ...
            each: function(e) {
                for (var t = this._groups, n = 0, a = t.length; n < a; ++n)
                    for (var r, i = t[n], f = 0, c = i.length; f < c; ++f)
                        (r = i[f]) && e.call(r, r.__data__, f, i);
                return this
            },
            attr: function(e, t) {
                var n = Pa(e);
            ...
            on: function(e, t, n) {
                ...
                if (c)
                    for (var o, u = 0, l = c.length; u < l; ++u)
                        for (a = 0,
                        o = c[u]; a < f; ++a)
                            if ((r = i[a]).type === o.type && r.name === o.name)
                                return o.value
            },
        ...
        Tr("7fc97fbeaed4fdc086ffff99386cb0f0027fbf5b17666666"),
        Tr("1b9e77d95f027570b3e7298a66a61ee6ab02a6761d666666"),
        Tr("a6cee31f78b4b2df8a33a02cfb9a99e31a1cfdbf6fff7f00cab2d66a3d9affff99b15928"),
        Tr("fbb4aeb3cde3ccebc5decbe4fed9a6ffffcce5d8bdfddaecf2f2f2"),
        Tr("b3e2cdfdcdaccbd5e8f4cae4e6f5c9fff2aef1e2cccccccc"),
        ...
        zr(new Array(3).concat("af8dc3f7f7f77fbf7b", "7b3294c2a5cfa6dba0008837", "7b3294c2a5cff7f7f7a6dba0008837", "762a83af8dc3e7d4e8d9f0d37fbf7b1b7837", "762a83af8dc3e7d4e8f7f7f7d9f0d37fbf7b1b7837", "762a839970abc2a5cfe7d4e8d9f0d3a6dba05aae611b7837", "762a839970abc2a5cfe7d4e8f7f7f7d9f0d3a6dba05aae611b7837", "40004b762a839970abc2a5cfe7d4e8d9f0d3a6dba05aae611b783700441b", "40004b762a839970abc2a5cfe7d4e8f7f7f7d9f0d3a6dba05aae611b783700441b").map(Tr)),
        zr(new Array(3).concat("e9a3c9f7f7f7a1d76a", "d01c8bf1b6dab8e1864dac26", "d01c8bf1b6daf7f7f7b8e1864dac26", "c51b7de9a3c9fde0efe6f5d0a1d76a4d9221", "c51b7de9a3c9fde0eff7f7f7e6f5d0a1d76a4d9221", "c51b7dde77aef1b6dafde0efe6f5d0b8e1867fbc414d9221", "c51b7dde77aef1b6dafde0eff7f7f7e6f5d0b8e1867fbc414d9221", "8e0152c51b7dde77aef1b6dafde0efe6f5d0b8e1867fbc414d9221276419", "8e0152c51b7dde77aef1b6dafde0eff7f7f7e6f5d0b8e1867fbc414d9221276419").map(Tr)),
        zr(new Array(3).concat("998ec3f7f7f7f1a340", "5e3c99b2abd2fdb863e66101", "5e3c99b2abd2f7f7f7fdb863e66101", "542788998ec3d8daebfee0b6f1a340b35806", "542788998ec3d8daebf7f7f7fee0b6f1a340b35806", "5427888073acb2abd2d8daebfee0b6fdb863e08214b35806", "5427888073acb2abd2d8daebf7f7f7fee0b6fdb863e08214b35806", "2d004b5427888073acb2abd2d8daebfee0b6fdb863e08214b358067f3b08", "2d004b5427888073acb2abd2d8daebf7f7f7fee0b6fdb863e08214b358067f3b08").map(Tr)),
        zr(new Array(3).concat("ef8a62f7f7f767a9cf", "ca0020f4a58292c5de0571b0", "ca0020f4a582f7f7f792c5de0571b0", "b2182bef8a62fddbc7d1e5f067a9cf2166ac", "b2182bef8a62fddbc7f7f7f7d1e5f067a9cf2166ac", "b2182bd6604df4a582fddbc7d1e5f092c5de4393c32166ac", "b2182bd6604df4a582fddbc7f7f7f7d1e5f092c5de4393c32166ac", "67001fb2182bd6604df4a582fddbc7d1e5f092c5de4393c32166ac053061", "67001fb2182bd6604df4a582fddbc7f7f7f7d1e5f092c5de4393c32166ac053061").map(Tr)),
        zr(new Array(3).concat("ef8a62ffffff999999", "ca0020f4a582bababa404040", "ca0020f4a582ffffffbababa404040", "b2182bef8a62fddbc7e0e0e09999994d4d4d", "b2182bef8a62fddbc7ffffffe0e0e09999994d4d4d", "b2182bd6604df4a582fddbc7e0e0e0bababa8787874d4d4d", "b2182bd6604df4a582fddbc7ffffffe0e0e0bababa8787874d4d4d", "67001fb2182bd6604df4a582fddbc7e0e0e0bababa8787874d4d4d1a1a1a", "67001fb2182bd6604df4a582fddbc7ffffffe0e0e0bababa8787874d4d4d1a1a1a").map(Tr));
        ...
        zr(new Array(3).concat("fc8d59ffffbf91cf60", "d7191cfdae61a6d96a1a9641", "d7191cfdae61ffffbfa6d96a1a9641", "d73027fc8d59fee08bd9ef8b91cf601a9850", "d73027fc8d59fee08bffffbfd9ef8b91cf601a9850", "d73027f46d43fdae61fee08bd9ef8ba6d96a66bd631a9850", "d73027f46d43fdae61fee08bffffbfd9ef8ba6d96a66bd631a9850", "a50026d73027f46d43fdae61fee08bd9ef8ba6d96a66bd631a9850006837", "a50026d73027f46d43fdae61fee08bffffbfd9ef8ba6d96a66bd631a9850006837").map(Tr)),
        zr(new Array(3).concat("fc8d59ffffbf99d594", "d7191cfdae61abdda42b83ba", "d7191cfdae61ffffbfabdda42b83ba", "d53e4ffc8d59fee08be6f59899d5943288bd", "d53e4ffc8d59fee08bffffbfe6f59899d5943288bd", "d53e4ff46d43fdae61fee08be6f598abdda466c2a53288bd", "d53e4ff46d43fdae61fee08bffffbfe6f598abdda466c2a53288bd", "9e0142d53e4ff46d43fdae61fee08be6f598abdda466c2a53288bd5e4fa2", "9e0142d53e4ff46d43fdae61fee08bffffbfe6f598abdda466c2a53288bd5e4fa2").map(Tr)),
        zr(new Array(3).concat("e5f5f999d8c92ca25f", "edf8fbb2e2e266c2a4238b45", "edf8fbb2e2e266c2a42ca25f006d2c", "edf8fbccece699d8c966c2a42ca25f006d2c", "edf8fbccece699d8c966c2a441ae76238b45005824", "f7fcfde5f5f9ccece699d8c966c2a441ae76238b45005824", "f7fcfde5f5f9ccece699d8c966c2a441ae76238b45006d2c00441b").map(Tr)),
        zr(new Array(3).concat("e0ecf49ebcda8856a7", "edf8fbb3cde38c96c688419d", "edf8fbb3cde38c96c68856a7810f7c", "edf8fbbfd3e69ebcda8c96c68856a7810f7c", "edf8fbbfd3e69ebcda8c96c68c6bb188419d6e016b", "f7fcfde0ecf4bfd3e69ebcda8c96c68c6bb188419d6e016b", "f7fcfde0ecf4bfd3e69ebcda8c96c68c6bb188419d810f7c4d004b").map(Tr)),
        zr(new Array(3).concat("e0f3dba8ddb543a2ca", "f0f9e8bae4bc7bccc42b8cbe", "f0f9e8bae4bc7bccc443a2ca0868ac", "f0f9e8ccebc5a8ddb57bccc443a2ca0868ac", "f0f9e8ccebc5a8ddb57bccc44eb3d32b8cbe08589e", "f7fcf0e0f3dbccebc5a8ddb57bccc44eb3d32b8cbe08589e", "f7fcf0e0f3dbccebc5a8ddb57bccc44eb3d32b8cbe0868ac084081").map(Tr)),
        zr(new Array(3).concat("fee8c8fdbb84e34a33", "fef0d9fdcc8afc8d59d7301f", "fef0d9fdcc8afc8d59e34a33b30000", "fef0d9fdd49efdbb84fc8d59e34a33b30000", "fef0d9fdd49efdbb84fc8d59ef6548d7301f990000", "fff7ecfee8c8fdd49efdbb84fc8d59ef6548d7301f990000", "fff7ecfee8c8fdd49efdbb84fc8d59ef6548d7301fb300007f0000").map(Tr)),
        zr(new Array(3).concat("ece2f0a6bddb1c9099", "f6eff7bdc9e167a9cf02818a", "f6eff7bdc9e167a9cf1c9099016c59", "f6eff7d0d1e6a6bddb67a9cf1c9099016c59", "f6eff7d0d1e6a6bddb67a9cf3690c002818a016450", "fff7fbece2f0d0d1e6a6bddb67a9cf3690c002818a016450", "fff7fbece2f0d0d1e6a6bddb67a9cf3690c002818a016c59014636").map(Tr)),
        zr(new Array(3).concat("ece7f2a6bddb2b8cbe", "f1eef6bdc9e174a9cf0570b0", "f1eef6bdc9e174a9cf2b8cbe045a8d", "f1eef6d0d1e6a6bddb74a9cf2b8cbe045a8d", "f1eef6d0d1e6a6bddb74a9cf3690c00570b0034e7b", "fff7fbece7f2d0d1e6a6bddb74a9cf3690c00570b0034e7b", "fff7fbece7f2d0d1e6a6bddb74a9cf3690c00570b0045a8d023858").map(Tr)),
        zr(new Array(3).concat("e7e1efc994c7dd1c77", "f1eef6d7b5d8df65b0ce1256", "f1eef6d7b5d8df65b0dd1c77980043", "f1eef6d4b9dac994c7df65b0dd1c77980043", "f1eef6d4b9dac994c7df65b0e7298ace125691003f", "f7f4f9e7e1efd4b9dac994c7df65b0e7298ace125691003f", "f7f4f9e7e1efd4b9dac994c7df65b0e7298ace125698004367001f").map(Tr)),
        zr(new Array(3).concat("fde0ddfa9fb5c51b8a", "feebe2fbb4b9f768a1ae017e", "feebe2fbb4b9f768a1c51b8a7a0177", "feebe2fcc5c0fa9fb5f768a1c51b8a7a0177", "feebe2fcc5c0fa9fb5f768a1dd3497ae017e7a0177", "fff7f3fde0ddfcc5c0fa9fb5f768a1dd3497ae017e7a0177", "fff7f3fde0ddfcc5c0fa9fb5f768a1dd3497ae017e7a017749006a").map(Tr)),
        zr(new Array(3).concat("edf8b17fcdbb2c7fb8", "ffffcca1dab441b6c4225ea8", "ffffcca1dab441b6c42c7fb8253494", "ffffccc7e9b47fcdbb41b6c42c7fb8253494", "ffffccc7e9b47fcdbb41b6c41d91c0225ea80c2c84", "ffffd9edf8b1c7e9b47fcdbb41b6c41d91c0225ea80c2c84", "ffffd9edf8b1c7e9b47fcdbb41b6c41d91c0225ea8253494081d58").map(Tr)),
        zr(new Array(3).concat("f7fcb9addd8e31a354", "ffffccc2e69978c679238443", "ffffccc2e69978c67931a354006837", "ffffccd9f0a3addd8e78c67931a354006837", "ffffccd9f0a3addd8e78c67941ab5d238443005a32", "ffffe5f7fcb9d9f0a3addd8e78c67941ab5d238443005a32", "ffffe5f7fcb9d9f0a3addd8e78c67941ab5d238443006837004529").map(Tr)),
        zr(new Array(3).concat("fff7bcfec44fd95f0e", "ffffd4fed98efe9929cc4c02", "ffffd4fed98efe9929d95f0e993404", "ffffd4fee391fec44ffe9929d95f0e993404", "ffffd4fee391fec44ffe9929ec7014cc4c028c2d04", "ffffe5fff7bcfee391fec44ffe9929ec7014cc4c028c2d04", "ffffe5fff7bcfee391fec44ffe9929ec7014cc4c02993404662506").map(Tr)),
        zr(new Array(3).concat("ffeda0feb24cf03b20", "ffffb2fecc5cfd8d3ce31a1c", "ffffb2fecc5cfd8d3cf03b20bd0026", "ffffb2fed976feb24cfd8d3cf03b20bd0026", "ffffb2fed976feb24cfd8d3cfc4e2ae31a1cb10026", "ffffccffeda0fed976feb24cfd8d3cfc4e2ae31a1cb10026", "ffffccffeda0fed976feb24cfd8d3cfc4e2ae31a1cbd0026800026").map(Tr)),
        zr(new Array(3).concat("deebf79ecae13182bd", "eff3ffbdd7e76baed62171b5", "eff3ffbdd7e76baed63182bd08519c", "eff3ffc6dbef9ecae16baed63182bd08519c", "eff3ffc6dbef9ecae16baed64292c62171b5084594", "f7fbffdeebf7c6dbef9ecae16baed64292c62171b5084594", "f7fbffdeebf7c6dbef9ecae16baed64292c62171b508519c08306b").map(Tr)),
        zr(new Array(3).concat("e5f5e0a1d99b31a354", "edf8e9bae4b374c476238b45", "edf8e9bae4b374c47631a354006d2c", "edf8e9c7e9c0a1d99b74c47631a354006d2c", "edf8e9c7e9c0a1d99b74c47641ab5d238b45005a32", "f7fcf5e5f5e0c7e9c0a1d99b74c47641ab5d238b45005a32", "f7fcf5e5f5e0c7e9c0a1d99b74c47641ab5d238b45006d2c00441b").map(Tr)),
        zr(new Array(3).concat("f0f0f0bdbdbd636363", "f7f7f7cccccc969696525252", "f7f7f7cccccc969696636363252525", "f7f7f7d9d9d9bdbdbd969696636363252525", "f7f7f7d9d9d9bdbdbd969696737373525252252525", "fffffff0f0f0d9d9d9bdbdbd969696737373525252252525", "fffffff0f0f0d9d9d9bdbdbd969696737373525252252525000000").map(Tr)),
        zr(new Array(3).concat("efedf5bcbddc756bb1", "f2f0f7cbc9e29e9ac86a51a3", "f2f0f7cbc9e29e9ac8756bb154278f", "f2f0f7dadaebbcbddc9e9ac8756bb154278f", "f2f0f7dadaebbcbddc9e9ac8807dba6a51a34a1486", "fcfbfdefedf5dadaebbcbddc9e9ac8807dba6a51a34a1486", "fcfbfdefedf5dadaebbcbddc9e9ac8807dba6a51a354278f3f007d").map(Tr)),
        zr(new Array(3).concat("fee0d2fc9272de2d26", "fee5d9fcae91fb6a4acb181d", "fee5d9fcae91fb6a4ade2d26a50f15", "fee5d9fcbba1fc9272fb6a4ade2d26a50f15", "fee5d9fcbba1fc9272fb6a4aef3b2ccb181d99000d", "fff5f0fee0d2fcbba1fc9272fb6a4aef3b2ccb181d99000d", "fff5f0fee0d2fcbba1fc9272fb6a4aef3b2ccb181da50f1567000d").map(Tr)),
        zr(new Array(3).concat("fee6cefdae6be6550d", "feeddefdbe85fd8d3cd94701", "feeddefdbe85fd8d3ce6550da63603", "feeddefdd0a2fdae6bfd8d3ce6550da63603", "feeddefdd0a2fdae6bfd8d3cf16913d948018c2d04", "fff5ebfee6cefdd0a2fdae6bfd8d3cf16913d948018c2d04", "fff5ebfee6cefdd0a2fdae6bfd8d3cf16913d94801a636037f2704").map(Tr)),
        ut(Ee(300, .5, 0), Ee(-240, .5, 1));
        ut(Ee(-100, .75, .35), Ee(80, 1.5, .8)),
        ut(Ee(260, .75, .35), Ee(80, 1.5, .8)),
        Ee(),
        ce(),
        Math.PI,
        Math.PI;
        ...
        function Br(e, t, n) {
            var a, r = e[0], i = e[e.length - 1], f = function(e, t, n) {
                var a = Math.abs(t - e) / Math.max(0, n)
                  , r = Math.pow(10, Math.floor(Math.log(a) / Math.LN10))
                  , i = a / r;
                return i >= Rr ? r *= 10 : i >= Ur ? r *= 5 : i >= Er && (r *= 2),
                t < e ? -r : r
            }(r, i, null == t ? 10 : t);
            switch ((n = Mt(null == n ? ",f" : n)).type) {
            case "s":
                var c = Math.max(Math.abs(r), Math.abs(i));
                return null != n.precision || isNaN(a = Lt(f, c)) || (n.precision = a),
                zt(n, c);
            case "":
            case "e":
            case "g":
        ...
        function $r(e) {
            ...
            e.nice = function(n) {
                ...
                i = f,
                f = a),
                (a = Yr(c, o, n)) > 0 ? a = Yr(c = Math.floor(c / a) * a, o = Math.ceil(o / a) * a, n) : a < 0 && (a = Yr(c = Math.ceil(c * a) / a, o = Math.floor(o * a) / a, n)),
                a > 0 ? (r[i] = Math.floor(c / a) * a,
                r[f] = Math.ceil(o / a) * a,
                t(r)) : a < 0 && (r[i] = Math.ceil(c * a) / a,
                r[f] = Math.floor(o * a) / a,
        ...
        function Gr() {
            var e = function(e, t) {
                var n, a, r, i = jr, f = jr, c = Ze, o = !1;
                function u() {
                    return n = Math.min(i.length, f.length) > 2 ? Wr : Vr,
                    a = r = null,
                    l
                }
                function l(t) {
                ...
                ,
                l.domain = function(e) {
                    return arguments.length ? (i = Or.call(e, Xr),
                    u()) : i.slice()
                }
                ,
                l.range = function(e) {
                    return arguments.length ? (f = Ir.call(e),
                    u()) : f.slice()
                }
                ,
            ...
            return e.copy = function() {
                return t = e,
                Gr().domain(t.domain()).range(t.range()).interpolate(t.interpolate()).clamp(t.clamp());
                var t
            }
            ,
            $r(e)
        ...
        Zr("1f77b4ff7f0e2ca02cd627289467bd8c564be377c27f7f7fbcbd2217becf"),
        Zr("393b795254a36b6ecf9c9ede6379398ca252b5cf6bcedb9c8c6d31bd9e39e7ba52e7cb94843c39ad494ad6616be7969c7b4173a55194ce6dbdde9ed6"),
        ...
        var Jr = r({
          ...
          , Kr = r({
            ...
            init: function(e, t) {
                t.id = "areaGradient" + Math.round(1e4 * Math.random()),
                t.gradient = Mr(e).append("linearGradient")
            },
            update: function(e) {
                ...
                a.exit().remove(),
                a.merge(a.enter().append("stop")).attr("offset", function(e) {
                    return e + "%"
          ...
          , ei = (r({
            ...
            init: function(e, t) {
                t.filter = Mr(e).append("defs").append("filter").attr("height", "130%"),
                t.filter.append("feGaussianBlur").attr("in", "SourceAlpha").attr("stdDeviation", 3),
                t.filter.append("feOffset").attr("dx", 2).attr("dy", 2).attr("result", "offsetblur");
                var n = t.filter.append("feMerge");
                n.append("feMergeNode"),
        ...
        r({
            ...
            init: function(e, t) {
                e = Mr(e),
                t.path = e.append("path"),
                t.transform = t.path.append("animateTransform").attr("attributeName", "transform").attr("attributeType", "XML").attr("type", "rotate").attr("begin", "0s").attr("fill", "freeze").attr("repeatCount", "indefinite")
            },
            update: function(e) {
                e.path.attr("d", function(e, t, n, a, r, i) {
                    ...
                    var f = n
                      , c = n - a
                      , o = [[e + f * Math.cos(r), t + f * Math.sin(r)], [e + f * Math.cos(i), t + f * Math.sin(i)], [e + c * Math.cos(i), t + c * Math.sin(i)], [e + c * Math.cos(r), t + c * Math.sin(r)]]
                      , u = (i - r) % (2 * Math.PI) > Math.PI ? 1 : 0
                      , l = [];
                    return l.push("M" + o[0].join()),
                    l.push("A" + [f, f, 0, u, 1, o[1]].join()),
                    l.push("L" + o[2].join()),
                    l.push("A" + [c, c, 0, u, 0, o[3]].join()),
                    l.push("z"),
                    l.join(" ")
                }(e.x, e.y, e.r, e.r / 3, 0, e.angleFull)).attr("fill", e.color),
                e.transform.attr("from", "0 " + e.x + " " + e.y).attr("to", "360 " + e.x + " " + e.y).attr("dur", e.duration + "s")
            }
        }),
        r({
            props: {
            ...
            methods: {
                show: function(e) {
                    return e.img.attr("width", e.maxWidth).attr("height", e.maxHeight),
                    this
                },
                hide: function(e) {
                    return e.img.attr("width", 0).attr("height", 0),
                    this
                }
            },
            init: function(e, t) {
        ...
        r({
            ...
            init: function(e, t, n) {
                ...
                t.xScale.range([f.left, a - t.margin.right]),
                t.yScale.range([f.top, r - t.margin.bottom]),
                t.svg = Mr(e).append("svg").attr("width", a).attr("height", r),
                t.outerBox = t.svg.append("rect").attr("x", t.xScale.range()[0]).attr("y", t.yScale.range()[0]).attr("rx", 2).attr("ry", 2).attr("width", t.xScale.range()[1]).attr("height", t.yScale.range()[1]).style("fill", "#EEE").style("stroke", "grey"),
                t.selectionBox = t.svg.append("rect").attr("rx", 1).attr("ry", 1).attr("width", 0).attr("height", 0).style("stroke", "blue").style("stroke-opacity", .6).style("fill", "blue").style("fill-opacity", .3)
            },
            update: function(e) {
                e.outerBox.attr("x", e.xScale.range()[0]).attr("y", e.yScale.range()[0]).attr("width", e.xScale.range()[1]).attr("height", e.yScale.range()[1]),
                e.selectionBox.attr("x", e.xScale(e.selection.x[0])).attr("y", e.yScale(e.selection.y[0])).attr("width", e.xScale(e.selection.x[1] - e.selection.x[0])).attr("height", e.yScale(e.selection.y[1] - e.selection.y[0]))
            }
        }),
        r({
            props: {
          ...
          , ti = (r({
            ...
            update: function(e) {
                for (var t, n, a = e.el.textContent, r = Math.round(a.length * e.maxWidth / e.el.getBBox().width * 1.2); --r && e.maxWidth / e.el.getBBox().width < 1; )
                    e.el.textContent = (n = r,
                    (t = a).length <= n ? t : t.substring(0, 2 * n / 3) + "..." + t.substring(t.length - n / 3, t.length))
            }
        }),
        t(function(e) {
            !function(t) {
                ...
                function u(e, o) {
                    ...
                    var l = function(e) {
                        ...
                        "object" == typeof e && (I(e.r) && I(e.g) && I(e.b) ? (h = e.r,
                        b = e.g,
                        g = e.b,
                        r = {
                            r: 255 * z(h, 255),
                        ...
                        s = !0,
                        d = "%" === String(e.r).substr(-1) ? "prgb" : "rgb") : I(e.h) && I(e.s) && I(e.v) ? (o = L(e.s),
                        u = L(e.v),
                        r = function(e, n, a) {
                            e = 6 * z(e, 360),
                            n = z(n, 100),
                        ...
                        s = !0,
                        d = "hsv") : I(e.h) && I(e.s) && I(e.l) && (o = L(e.s),
                        l = L(e.l),
                        r = function(e, t, n) {
                            var a, r, i;
                            function f(e, t, n) {
                    ...
                    this._format = o.format || l.format,
                ...
                function l(e, t, n) {
                    ...
                    t = z(t, 255),
                    n = z(n, 255);
                    var a, r, i = c(e, t, n), o = f(e, t, n), u = (i + o) / 2;
                    if (i == o)
                        a = r = 0;
                    else {
                        var l = i - o;
                        switch (r = u > .5 ? l / (2 - i - o) : l / (i + o),
                        i) {
                        case e:
                            a = (t - n) / l + (t < n ? 6 : 0);
                            break;
                ...
                function s(e, t, n) {
                    ...
                    t = z(t, 255),
                    n = z(n, 255);
                    var a, r, i = c(e, t, n), o = f(e, t, n), u = i, l = i - o;
                    if (r = 0 === i ? 0 : l / i,
                    i == o)
                        a = 0;
                    else {
                ...
                function v(e, t) {
                    t = 0 === t ? 0 : t || 10;
                    var n = u(e).toRgb();
                    return n.r = c(0, f(255, n.r - i(-t / 100 * 255))),
                    n.g = c(0, f(255, n.g - i(-t / 100 * 255))),
                    n.b = c(0, f(255, n.b - i(-t / 100 * 255))),
                    u(n)
                }
                function y(e, t) {
                    t = 0 === t ? 0 : t || 10;
                ...
                function k(e, t) {
                    t = t || 6;
                    for (var n = u(e).toHsv(), a = n.h, r = n.s, i = n.v, f = [], c = 1 / t; t--; )
                        f.push(u({
                            h: a,
                            s: r,
                            v: i
                ...
                u.prototype = {
                    ...
                    getLuminance: function() {
                        ...
                        n = r.g / 255,
                        a = r.b / 255,
                        .2126 * (e <= .03928 ? e / 12.92 : t.pow((e + .055) / 1.055, 2.4)) + .7152 * (n <= .03928 ? n / 12.92 : t.pow((n + .055) / 1.055, 2.4)) + .0722 * (a <= .03928 ? a / 12.92 : t.pow((a + .055) / 1.055, 2.4))
                    },
                    setAlpha: function(e) {
                        return this._a = C(e),
                        this._roundA = i(100 * this._a) / 100,
                    ...
                    toHex8: function(e) {
                        return function(e, t, n, a, r) {
                            ...
                            if (r && f[0].charAt(0) == f[0].charAt(1) && f[1].charAt(0) == f[1].charAt(1) && f[2].charAt(0) == f[2].charAt(1) && f[3].charAt(0) == f[3].charAt(1))
                    ...
                    toString: function(e) {
                        ...
                        return t || !a || "hex" !== e && "hex6" !== e && "hex3" !== e && "hex4" !== e && "hex8" !== e && "name" !== e ? ("rgb" === e && (n = this.toRgbString()),
                ...
                u.fromRatio = function(e, t) {
                    if ("object" == typeof e) {
                        var n = {};
                        for (var a in e)
                            e.hasOwnProperty(a) && (n[a] = "a" === a ? e[a] : L(e[a]));
                        e = n
                    }
                    return u(e, t)
                }
                ...
                u.mostReadable = function(e, t, n) {
                    var a, r, i, f, c = null, o = 0;
                    r = (n = n || {}).includeFallbackColors,
                    i = n.level,
                    f = n.size;
                    for (var l = 0; l < t.length; l++)
                        (a = u.readability(e, t[l])) > o && (o = a,
                        c = u(t[l]));
                ...
                var E, Y, P, O = (Y = "[\\s|\\(]+(" + (E = "(?:[-\\+]?\\d*\\.\\d+%?)|(?:[-\\+]?\\d+%?)") + ")[,|\\s]+(" + E + ")[,|\\s]+(" + E + ")\\s*\\)?",
                P = "[\\s|\\(]+(" + E + ")[,|\\s]+(" + E + ")[,|\\s]+(" + E + ")[,|\\s]+(" + E + ")\\s*\\)?",
                {
          ...
          , ni = r({
            ...
            init: function(e, t) {
                t.gradient = Kr()(e),
                t.el = Mr(e),
                t.box = t.el.append("rect").attr("x", 0).attr("y", 0).attr("rx", 3).attr("ry", 3).attr("stroke", "black").attr("stroke-width", .5),
                t.unitLabel = t.el.append("text").attr("class", "legendText").style("text-anchor", "middle").style("dominant-baseline", "central"),
                t.labelFitText = ei()(t.unitLabel.node()),
                t.startLabel = t.el.append("text").style("text-anchor", "start").style("dominant-baseline", "central"),
                t.startLabelFitText = ei()(t.startLabel.node()),
                t.endLabel = t.el.append("text").style("text-anchor", "end").style("dominant-baseline", "central"),
            ...
            update: function(e) {
                ...
                e.startLabel.text(e.scale.domain()[0]).attr("x", .02 * e.width).attr("y", .5 * e.height).style("fill", ti(e.scale(e.scale.domain()[0])).isLight() ? "#444" : "#CCC"),
                e.startLabelFitText.bbox({
                    width: .3 * e.width,
                    height: .7 * e.height
                }),
                e.endLabel.text(e.scale.domain()[e.scale.domain().length - 1]).attr("x", .98 * e.width).attr("y", .5 * e.height).style("fill", ti(e.scale(e.scale.domain()[e.scale.domain().length - 1])).isLight() ? "#444" : "#CCC"),
                e.endLabelFitText.bbox({
                    width: .3 * e.width,
                    height: .7 * e.height
                })
            }
          ...
          , ai = r({
            ...
            update: function(e) {
                ...
                a.append("rect").attr("y", 0).attr("rx", 0).attr("ry", 0).attr("stroke-width", 0).on("click", function(d) {
                    var categoryLabels = [ '', '접수', '위원회 심사', '체계지구 심사', '본회의 심의', '정부 이송', '공포', '대안반영폐기', '폐기', '철회', '의결' ];
                        var data = original2.slice();
                        var deleter=new Array;
                            for(var i = 0; i<data.length; i++){
                                if(categoryLabels[data[i].value] != d)
                                    deleter.push(i);
                            }
                            for(var i = deleter.length-1; i>-1; i--)
                                data.splice(deleter[i],1);
                        teep(data,d,original2);
                    return;
                }),
                a.append("text").style("text-anchor", "middle").style("dominant-baseline", "central").on("click", function(d) {
                    var categoryLabels = [ '', '접수', '위원회 심사', '체계지구 심사', '본회의 심의', '정부 이송', '공포', '대안반영폐기', '폐기', '철회', '의결' ];
                        var data = original2.slice();
                        var deleter=new Array;
                            for(var i = 0; i<data.length; i++){
                        ...
                        myChart.data(getLawData(true, d));
                    return;
                }),
                a.append("title"),
                (n = n.merge(a)).select("rect").attr("width", t).attr("height", e.height).attr("x", function(e, n) {
                    return t * n
          ...
          , ri = r({
            ...
            update: function(e) {
                if (e.scale) {
                    ...
                    e.legend.html(""),
                    (t ? ai : ni)().width(e.width).height(e.height).scale(e.scale).label(e.label)(e.legend.node())
                }
            }
        })
          , ii = {
        ...
        function ui(e, t, n) {
            for (var a = 0, r = e.length; a < r; ++a)
                if (e[a].name === t) {
                    e[a] = ii,
                    e = e.slice(0, a).concat(e.slice(a + 1));
                    break
                }
        ...
        ci.prototype = fi.prototype = {
            constructor: ci,
            on: function(e, t) {
                var n, a, r = this._, i = (a = r,
                (e + "").trim().split(/^|\s+/).map(function(e) {
                    var t = ""
                      , n = e.indexOf(".");
                ...
                if (!(arguments.length < 2)) {
                    ...
                    for (; ++f < c; )
                        if (n = (e = i[f]).type)
                            ...
                            for (n in r)
                                r[n] = ui(r[n], e.name, null);
                    return this
                }
                for (; ++f < c; )
                    if ((n = (e = i[f]).type) && (n = oi(r[n], e.name)))
                        return n
            },
            copy: function() {
                var e = {}
            ...
            call: function(e, t) {
                if ((n = arguments.length - 2) > 0)
                    for (var n, a, r = new Array(n), i = 0; i < n; ++i)
                        r[i] = arguments[i + 2];
                if (!this._.hasOwnProperty(e))
                    throw new Error("unknown type: " + e);
                for (i = 0,
                n = (a = this._[e]).length; i < n; ++i)
                    a[i].value.apply(t, r)
            },
            apply: function(e, t, n) {
                if (!this._.hasOwnProperty(e))
                    throw new Error("unknown type: " + e);
                for (var a = this._[e], r = 0, i = a.length; r < i; ++r)
                    a[r].value.apply(t, n)
            }
        };
        var si, di, hi = 0, bi = 0, gi = 0, pi = 1e3, mi = 0, vi = 0, yi = 0, wi = "object" == typeof performance && performance.now ? performance : Date, xi = "object" == typeof window && window.requestAnimationFrame ? window.requestAnimationFrame.bind(window) : function(e) {
            setTimeout(e, 17)
        }
        ;
        function _i() {
        ...
        function ki() {
            ...
            try {
                !function() {
                    ...
                    ++hi;
                    for (var e, t = si; t; )
                        (e = vi - t._time) >= 0 && t._call.call(null, e),
                        t = t._next;
                    --hi
                }()
            } finally {
        ...
        function Di(e) {
            hi || (bi && (bi = clearTimeout(bi)),
            e - vi > 24 ? (e < 1 / 0 && (bi = setTimeout(ki, e - wi.now() - yi)),
            gi && (gi = clearInterval(gi))) : (gi || (mi = wi.now(),
            gi = setInterval(Ti, pi)),
            hi = 1,
            xi(ki)))
        }
        function Ci(e, t, n) {
        ...
        Ai.prototype = Si.prototype = {
            ...
            restart: function(e, t, n) {
                ...
                n = (null == n ? _i() : +n) + (null == t ? 0 : +t),
                this._next || di === this || (di ? di._next = this : si = this,
                di = this),
                this._call = e,
                this._time = n,
                Di()
                ...
                function i(o) {
                    ...
                    for (u in r)
                        if ((d = r[u]).name === n.name) {
                            if (d.state === Ri)
                                return Ci(i);
                            d.state === Ui ? (d.state = Yi,
                            d.timer.stop(),
                            d.on.call("interrupt", e, e.__data__, d.index, d.group),
                            delete r[u]) : +u < t && (d.state = Yi,
                            d.timer.stop(),
                            d.on.call("cancel", e, e.__data__, d.index, d.group),
                            delete r[u])
                        }
                    if (Ci(function() {
                        n.state === Ri && (n.state = Ui,
                        n.timer.restart(f, n.delay, n.time),
                        f(o))
                    }),
                    n.state = Li,
                    ...
                    n.state === Li) {
                        for (n.state = Ri,
                        a = new Array(s = n.tween.length),
                        u = 0,
                        l = -1; u < s; ++u)
                            (d = n.tween[u].value.call(e, e.__data__, n.index, n.group)) && (a[++l] = d);
                        a.length = l + 1
                    }
                }
                function f(t) {
                    for (var r = t < n.duration ? n.ease.call(null, t / n.duration) : (n.timer.restart(c),
                    n.state = Ei,
                    1), i = -1, f = a.length; ++i < f; )
                        a[i].call(e, r);
                    n.state === Ei && (n.on.call("end", e, e.__data__, n.index, n.group),
                    c())
                }
                function c() {
                    for (var a in n.state = Yi,
                    n.timer.stop(),
                    delete r[t],
                    r)
                        return;
        ...
        function ji(e, t) {
            var n, a, r, i = e.__transition, f = !0;
            if (i) {
                for (r in t = null == t ? null : t + "",
                i)
                    (n = i[r]).name === t ? (a = n.state > Li && n.state < Ei,
                    n.state = Yi,
                    n.timer.stop(),
        ...
        function Vi(e, t) {
            var n;
            return ("number" == typeof t ? We : t instanceof ae ? je : (n = ae(t)) ? (t = n,
            je) : Ge)(e, t)
        }
        ...
        .prototype = {
            ...
            select: function(e) {
                ...
                for (var a = this._groups, r = a.length, i = new Array(r), f = 0; f < r; ++f)
                    for (var c, o, u = a[f], l = u.length, s = i[f] = new Array(l), d = 0; d < l; ++d)
                        (c = u[d]) && (o = e.call(c, c.__data__, d, u)) && ("__data__"in c && (o.__data__ = c.__data__),
                        s[d] = o,
                        Pi(s[d], t, n, d, s, Xi(c, n)));
            ...
            selectAll: function(e) {
                ...
                for (var a = this._groups, r = a.length, i = [], f = [], c = 0; c < r; ++c)
                    for (var o, u = a[c], l = u.length, s = 0; s < l; ++s)
                        if (o = u[s]) {
                            for (var d, h = e.call(o, o.__data__, s, u), b = Xi(o, n), g = 0, p = h.length; g < p; ++g)
                                (d = h[g]) && Pi(d, t, n, g, h, b);
                            i.push(h),
                            f.push(o)
                        }
            ...
            attr: function(e, t) {
                ...
                return this.attrTween(e, "function" == typeof t ? (n.local ? function(e, t, n) {
                    ...
                    return function() {
                        var f, c, o = n(this);
                        if (null != o)
                            return (f = this.getAttributeNS(e.space, e.local)) === (c = o + "") ? null : f === a && c === r ? i : (r = c,
                            i = t(a = f, o));
                        this.removeAttributeNS(e.space, e.local)
                    }
                }
                : function(e, t, n) {
                    ...
                    return function() {
                        var f, c, o = n(this);
                        if (null != o)
                            return (f = this.getAttribute(e)) === (c = o + "") ? null : f === a && c === r ? i : (r = c,
                            i = t(a = f, o));
                        this.removeAttribute(e)
                    }
                }
                ...
                return null == t ? this.styleTween(e, function(e, t) {
                    ...
                    return function() {
                        var f = Ka(this, e)
                          , c = n(this)
                          , o = c + "";
                        return null == c && (this.style.removeProperty(e),
                        o = c = Ka(this, e)),
                        f === o ? null : f === a && o === r ? i : (r = o,
                        i = t(a = f, c))
                    }
                }(e, a, qi(this, "style." + e, t))).each(function(e, t) {
                    var n, a, r, i, f = "style." + t, c = "end." + f;
                    return function() {
                        var o = Ii(this, e)
                          , u = o.on
                          , l = null == o.value[f] ? i || (i = Bi(t)) : void 0;
                        u === n && r === l || (a = (n = u).copy()).on(c, r = l),
                        o.on = a
                    }
            ...
            ease: function(e) {
                ...
                return new Promise(function(i, f) {
                    ...
                    n.each(function() {
                        var n = Ii(this, a)
                          , r = n.on;
                        r !== e && ((t = (e = r).copy())._.cancel.push(c),
                        t._.interrupt.push(c),
                        t._.end.push(o)),
                        n.on = t
                    })
                }
        ...
        _r.prototype.transition = function(e) {
            var t, n;
            e instanceof Gi ? (t = e._id,
            e = e._name) : (t = Zi(),
            (n = Ji).time = _i(),
            e = null == e ? null : e + "");
            for (var a = this._groups, r = a.length, i = 0; i < r; ++i)
                for (var f, c = a[i], o = c.length, u = 0; u < o; ++u)
                    (f = c[u]) && Pi(f, e, t, u, c, n || Ki(f, t));
        ...
        function xf() {
            return function(e) {
                var t, n = vf, a = mf, r = fi(f, "start", "brush", "end"), i = 6;
                function f(t) {
                ...
                function l() {
                    if (br.touches) {
                        if (br.changedTouches.length < br.touches.length)
                            return af()
                    } else if (t)
                        return;
                    if (a.apply(this, arguments)) {
                        var n, r, i, f, u, l, s, d, h, b, g, p, m, v = this, y = br.target.__data__.type, w = "selection" === (br.metaKey ? y = "overlay" : y) ? rf : br.altKey ? of : cf, x = e === lf ? null : bf[y], _ = e === uf ? null : gf[y], M = yf(v), A = M.extent, S = M.selection, k = A[0][0], T = A[0][1], D = A[1][0], C = A[1][1], z = x && _ && br.shiftKey, N = Sr(v), F = N, H = o(v, arguments).beforestart();
                        "overlay" === y ? M.selection = S = [[n = e === lf ? k : N[0], i = e === uf ? T : N[1]], [u = e === lf ? D : n, s = e === uf ? C : i]] : (n = S[0][0],
                        i = S[0][1],
                        u = S[1][0],
                        s = S[1][1]),
                        r = n,
                        ...
                        if (br.touches)
                            L.on("touchmove.brush", E, !0).on("touchend.brush touchcancel.brush", P, !0);
                        else {
                            var U = Mr(br.view).on("keydown.brush", function() {
                                ...
                                case 18:
                                    ...
                                    break;
                                case 32:
                                    w !== cf && w !== of || (x < 0 ? u = l - h : x > 0 && (n = r - h),
                                    _ < 0 ? s = d - b : _ > 0 && (i = f - b),
                                    w = ff,
                                    R.attr("cursor", sf.selection),
                                    Y());
                                    break;
                                default:
                                    return
                                ...
                                case 16:
                                    ...
                                    break;
                                case 18:
                                    w === of && (x < 0 ? u = l : x > 0 && (n = r),
                                    _ < 0 ? s = d : _ > 0 && (i = f),
                                    w = cf,
                                    Y());
                                    break;
                                case 32:
                                    w === ff && (br.altKey ? (x && (u = l - h * x,
                                    n = r + h * x),
                                    _ && (s = d - b * _,
                                    i = f + b * _),
                                    w = of) : (x < 0 ? u = l : x > 0 && (n = r),
                            ...
                            !function(e) {
                                ...
                                "onselectstart"in t ? n.on("selectstart.drag", li, !0) : (t.__noselect = t.style.MozUserSelect,
                    ...
                    function E() {
                        var e = Sr(v);
                        !z || p || m || (Math.abs(e[0] - F[0]) > Math.abs(e[1] - F[1]) ? m = !0 : p = !0),
                        F = e,
                        g = !0,
                        af(),
                        Y()
                    ...
                    function Y() {
                        ...
                        case ff:
                        case rf:
                            x && (h = Math.max(k - n, Math.min(D - u, h)),
                            r = n + h,
                            l = u + h),
                            _ && (b = Math.max(T - i, Math.min(C - s, b)),
                            f = i + b,
                            d = s + b);
                            break;
                        case cf:
                            x < 0 ? (h = Math.max(k - n, Math.min(D - n, h)),
                            r = n + h,
                            l = u) : x > 0 && (h = Math.max(k - u, Math.min(D - u, h)),
                            r = n,
                            l = u + h),
                            _ < 0 ? (b = Math.max(T - i, Math.min(C - i, b)),
                            f = i + b,
                            d = s) : _ > 0 && (b = Math.max(T - s, Math.min(C - s, b)),
                            f = i,
                            d = s + b);
                            break;
                        case of:
                            x && (r = Math.max(k, Math.min(D, n - h * x)),
                            l = Math.max(k, Math.min(D, u + h * x))),
                            _ && (f = Math.max(T, Math.min(C, i - b * _)),
                            d = Math.max(T, Math.min(C, s + b * _)))
                        }
                        l < r && (x *= -1,
                        e = n,
                        n = u,
                        ...
                        r = l,
                        l = e,
                        y in df && R.attr("cursor", sf[y = df[y]])),
                        d < f && (_ *= -1,
                        e = i,
                        i = s,
                        s = e,
                        ...
                        f = d,
                        d = e,
                        y in hf && R.attr("cursor", sf[y = hf[y]])),
                        M.selection && (S = M.selection),
                        p && (r = S[0][0],
                        l = S[1][0]),
                        m && (f = S[0][1],
                        d = S[1][1]),
                        S[0][0] === r && S[0][1] === f && S[1][0] === l && S[1][1] === d || (M.selection = [[r, f], [l, d]],
                        c.call(v),
                        H.brush())
                    }
                    function P() {
                        ...
                        br.touches) {
                            ...
                            !function(e, t) {
                                ...
                                t && (a.on("click.drag", li, !0),
                                setTimeout(function() {
                                    a.on("click.drag", null)
                                }, 0)),
                                "onselectstart"in n ? a.on("selectstart.drag", null) : (n.style.MozUserSelect = n.__noselect,
                                delete n.__noselect)
                            }(br.view, g),
                            U.on("keydown.brush keyup.brush mousemove.brush mouseup.brush", null);
                        L.attr("pointer-events", "all"),
                        R.attr("cursor", sf.overlay),
                        M.selection && (S = M.selection),
                        wf(S) && (M.selection = null,
                        c.call(v)),
                        H.end()
                    }
                }
                function s() {
                    ...
                    return t.extent = n.apply(this, arguments),
                    t.dim = e,
                    t
                }
                return f.move = function(t, n) {
                    t.selection ? t.on("start.brush", function() {
                        ...
                        ji(this),
                        a.selection = null == r || wf(r) ? null : r,
                        c.call(this),
                        i.start().brush().end()
                    })
                }
                ...
                f.extent = function(e) {
                    return arguments.length ? (n = "function" == typeof e ? e : ef([[+e[0][0], +e[0][1]], [+e[1][0], +e[1][1]]]),
                    f) : n
                }
                ,
                f.filter = function(e) {
                    return arguments.length ? (a = "function" == typeof e ? e : ef(!!e),
                    f) : a
                }
                ,
        ...
        var _f = r({
            ...
            init: function(t, n) {
                n.xGrid = x().tickFormat(""),
                n.xAxis = x().tickPadding(0),
                n.brush = xf().on("end", function() {
                    if (br.sourceEvent) {
                        var t = br.selection ? br.selection.map(n.scale.invert) : n.scale.domain();
                        n.onChange.apply(n, e(t))
                    }
                }),
                n.svg = Mr(t).append("svg").attr("class", "brusher").attr("hidden",true);
                var a = n.svg.append("g").attr("class", "brusher-margins");
                a.append("rect").attr("class", "grid-background"),
                a.append("g").attr("class", "x grid"),
                a.append("g").attr("class", "x axis"),
                a.append("g").attr("class", "brush")
            },
            update: function(e) {
                if (!(e.domainRange[1] <= e.domainRange[0])) {
                    var t = e.width - e.margins.left - e.margins.right
                      , n = e.height - e.margins.top - e.margins.bottom;
                    e.scale.domain(e.domainRange).range([0, t]),
                    e.xAxis.scale(e.scale).tickFormat(e.tickFormat),
                    e.xGrid.scale(e.scale).tickSize(-n),
                    e.svg.attr("width", e.width).attr("height", e.height),
                    e.svg.select(".brusher-margins").attr("transform", "translate(".concat(e.margins.left, ",").concat(e.margins.top, ")")),
                    e.svg.select(".grid-background").attr("width", t).attr("height", n),
                    e.svg.select(".x.grid").attr("transform", "translate(0," + n + ")").call(e.xGrid),
                    e.svg.select(".x.axis").attr("transform", "translate(0," + n + ")").call(e.xAxis).selectAll("text").attr("y", 8),
                    e.svg.select(".brush").call(e.brush.extent([[0, 0], [t, n]])).call(e.brush.move, e.currentSelection.map(e.scale)).selectAll("rect").attr("height", n)
                }
            }
        });
        function Mf(e, t) {
        ...
        return r({
            props: {
                data: {
                    ...
                    onChange: function(e, t) {
                        !function(e) {
                            ...
                            for (var n = !!e.length && e[0].data[0].data[0].timeRange[0]instanceof Date, a = 0, r = e.length; a < r; a++) {
                                ...
                                for (var f = 0, c = e[a].data.length; f < c; f++) {
                                    for (var o = 0, u = e[a].data[f].data.length; o < u; o++)
                                        t.completeFlatData.push({
                                            group: i,
                        ...
                        t.zoomX = [u(t.completeFlatData, function(e) {
                            return e.timeRange[0]
                        }), o(t.completeFlatData, function(e) {
                            return e.timeRange[1]
                        })],
                        t.zoomY = [null, null],
                        t.overviewArea && t.overviewArea.domainRange(t.zoomX).currentSelection(t.zoomX)
                    }
                },
                width: {
            ...
            methods: {
                ...
                zoomYLabels: function(e, t) {
                    ...
                    function n(t) {
                        ...
                        for (var n = t, a = 0, r = e.completeStructData.length; a < r; a++) {
                            if (e.completeStructData[a].lines.length > n)
                                return i(e.completeStructData[a], n);
                        ...
                        for (var r = 0, i = 0, f = e.completeStructData.length; i < f; i++) {
                            ...
                            if (0 == c && t.group == e.completeStructData[i].group) {
                                for (var o = 0, u = e.completeStructData[i].lines.length; o < u; o++) {
                                    ...
                                    if (l < 0)
                                        return r + o - a;
                                    if (0 == l && t.label == e.completeStructData[i].lines[o])
                                        return r + o
                                }
                ...
                sort: function(e, t, n) {
                    null == t && (t = e.labelCmpFunction),
                    null == n && (n = e.grpCmpFunction),
                    e.labelCmpFunction = t,
                    e.grpCmpFunction = n,
                    e.completeStructData.sort(function(e, t) {
                        return n(e.group, t.group)
                    });
                    for (var a = 0, r = e.completeStructData.length; a < r; a++)
                        e.completeStructData[a].lines.sort(t);
                    return e._rerender(),
                    this
                },
                ...
                sortChrono: function(e, t) {
                    function n(t) {
                        ...
                        }, r = 0, i = e.completeFlatData.length; r < i; r++)
                            a(r);
                        return n
                    }
                    null == t && (t = !0);
                ...
                overviewDomain: function(e, t) {
                    return e.enableOverview ? t ? (e.overviewArea.domainRange(t),
                    this) : e.overviewArea.domainRange() : null
                },
                refresh: function(e) {
                    return e._rerender(),
                    this
            ...
            init: function(e, t) {
                ...
                t.svg = a.append("svg"),
                t.overviewAreaElem = a.append("div"),
                t.yScale = I(),
                t.grpScale = P(),
                t.xAxis = x(),
                t.xGrid = w(d, n),
                ...
                function() {
                    t.yScale.invert = n,
                    t.grpScale.invert = n,
                    t.groupGradId = Kr().colorScale(function e() {
                        var t = vt(dt, dt);
                    ...
                    e.append("g").attr("class", "y-axis"),
                    e.append("g").attr("class", "grp-axis"),
                    t.yAxis.scale(t.yScale).tickSize(0),
                    t.grpAxis.scale(t.grpScale).tickSize(0),
                    t.colorLegend = ri()(t.svg.append("g").attr("class", "legendG").node()),
                    t.graph = t.svg.append("g"),
                    t.dateMarkerLine = t.svg.append("line").attr("class", "x-axis-date-marker"),
                    t.enableOverview && (t.overviewArea = _f().margins({
                        top: 1,
                        right: 20,
                        bottom: 20,
                        left: 20
                    ...
                    }).domainRange(t.zoomX).currentSelection(t.zoomX)(t.overviewAreaElem.node()),
                    t.svg.on("zoomScent", function() {
                        var e = br.detail.zoomX;
                        t.overviewArea && e && ((e[0] < t.overviewArea.domainRange()[0] || e[1] > t.overviewArea.domainRange()[1]) && t.overviewArea.domainRange([new Date(Math.min(e[0], t.overviewArea.domainRange()[0])), new Date(Math.max(e[1], t.overviewArea.domainRange()[1]))]),
                        t.overviewArea.currentSelection(e))
                    }));
                    function n(e, t) {
                        t = t || function(e, t) {
                            return e >= t
                        ...
                        for (var r = a[0], i = 0, f = a.length; i < f; i++)
                            if (t(a[i] + r, e))
                                return n[Math.round(i * n.length / a.length)];
                ...
                t.groupTooltip = kr().attr("class", "chart-tooltip group-tooltip").direction("w").offset([0, 0]).html(function(e) {
                    ...
                    return t.groupTooltip.offset([a, -n]),
                    e.group
                }),
                t.svg.call(t.groupTooltip),
                t.lineTooltip = kr().attr("class", "chart-tooltip line-tooltip").direction("e").offset([0, 0]).html(function(e) {
                    var n = e.hasOwnProperty("timeRange") ? t.xScale.range()[1] - t.xScale(e.timeRange[1]) : 0;
                    return t.lineTooltip.offset([0, n]),
                    e.label
                }),
                t.svg.call(t.lineTooltip),
                t.segmentTooltip = kr().attr("class", "chart-tooltip segment-tooltip").direction("s").offset([5, 0]).html(function(e) {
                ...
                t.svg.call(t.segmentTooltip),
                t.graph.on("mousedown", function() {
                    if (null == Mr(window).on("mousemove.zoomRect")) {
                        ...
                        if (!(Sr(e)[0] < 0 || Sr(e)[0] > t.graphW || Sr(e)[1] < 0 || Sr(e)[1] > t.graphH)) {
                            ...
                            Mr(window).on("mousemove.zoomRect", function() {
                                ...
                                n.attr("x", Math.min(a[0], r[0])).attr("y", Math.min(a[1], r[1])).attr("width", Math.abs(r[0] - a[0])).attr("height", Math.abs(r[1] - a[1])),
                                t.svg.dispatch("zoomScent", {
                                    detail: {
                                ...
                                Mr(window).on("mousemove.zoomRect", null).on("mouseup.zoomRect", null),
                                Mr("body").classed("stat-noselect", !1),
                                n.remove(),
                                t.disableHover = !1;
                                var r = [Math.max(0, Math.min(t.graphW, Sr(e)[0])), Math.max(0, Math.min(t.graphH, Sr(e)[1]))];
                                if (a[0] != r[0] || a[1] != r[1]) {
                ...
                t.svg.on("zoom", function() {
                    ...
                    r && (t._rerender(),
                    t.onZoom && t.onZoom(t.zoomX, t.zoomY)))
                }),
                t.svg.on("resetZoom", function() {
                    var e = t.zoomX
                      ...
                      , r = [null, null];
                    (e[0] < a[0] || e[1] > a[1] || n[0] != r[0] || n[1] != a[1]) && (t.zoomX = [new Date(Math.min(e[0], a[0])), new Date(Math.max(e[1], a[1]))],
                    t.zoomY = r,
                    t.svg.dispatch("zoomScent", {
                        detail: {
                            zoomX: t.zoomX,
            ...
            update: function(t) {
                !function() {
                    ...
                    null == t.zoomY || t.zoomY == [null, null]) {
                        t.structData = t.completeStructData,
                        t.nLines = 0;
                        for (var e = 0, n = t.structData.length; e < n; e++)
                            t.nLines += t.structData[e].lines.length;
                        return
                    }
                    t.structData = [];
                    var a = [null == t.zoomY[0] ? 0 : t.zoomY[0]];
                    a.push(Math.max(0, (null == t.zoomY[1] ? t.totalNLines : t.zoomY[1] + 1) - a[0])),
                    t.nLines = a[1];
                    var r = function(e, n) {
                        ...
                        if (r.length - a[0] >= a[1])
                            return i.lines = r.slice(a[0], a[1] + a[0]),
                            t.structData.push(i),
                            a[1] = 0,
                            "break";
                        a[0] > 0 ? (i.lines = r.slice(a[0]),
                        a[0] = 0) : i.lines = r,
                        t.structData.push(i),
                        a[1] -= i.lines.length
                    };
                ...
                t.graphW = t.width - t.leftMargin - t.rightMargin,
                t.graphH = u([t.nLines * t.maxLineHeight, t.maxHeight - t.topMargin - t.bottomMargin]),
                t.height = t.graphH + t.topMargin + t.bottomMargin,
                t.svg.transition().duration(t.transDuration).attr("width", t.width).attr("height", t.height),
                t.graph.attr("transform", "translate(" + t.leftMargin + "," + t.topMargin + ")"),
                t.overviewArea && t.overviewArea.width(.8 * t.width).height(t.overviewHeight + t.overviewArea.margins().top + t.overviewArea.margins().bottom),
                t.zoomX[0] = t.zoomX[0] || u(t.flatData, function(e) {
                    return e.timeRange[0]
                }),
                ...
                )().domain(t.zoomX).range([0, t.graphW]).clamp(!0),
                t.overviewArea && t.overviewArea.scale(t.xScale.copy()).tickFormat(t.xTickFormat),
                function() {
                    for (var e = [], n = function(n, a) {
                        e = e.concat(t.structData[n].lines.map(function(e) {
                            return t.structData[n].group + "+&+" + e
                        }))
                    }, a = 0, r = t.structData.length; a < r; a++)
                        n(a, r);
                    t.yScale.domain(e),
                    t.yScale.range([t.graphH / e.length * .5, t.graphH * (1 - .5 / e.length)])
                }(),
                function() {
                ...
                function() {
                    t.svg.select(".axises").attr("transform", "translate(" + t.leftMargin + "," + t.topMargin + ")"),
                    t.xAxis.scale(t.xScale).ticks(Math.round(.0011 * t.graphW)).tickFormat(t.xTickFormat),
                    t.xGrid.scale(t.xScale).ticks(t.xAxis.ticks()[0]).tickFormat(""),
                    ...
                    t.dateMarker && t.dateMarker >= t.xScale.domain()[0] && t.dateMarker <= t.xScale.domain()[1] ? t.dateMarkerLine.style("display", "block").transition().duration(t.transDuration).attr("x1", t.xScale(t.dateMarker) + t.leftMargin).attr("x2", t.xScale(t.dateMarker) + t.leftMargin).attr("y1", t.topMargin + 1).attr("y2", t.graphH + t.topMargin) : t.dateMarkerLine.style("display", "none");
                    ...
                    r = Math.min(14, .6 * f * Math.sqrt(2)),
                    i = Math.floor(t.leftMargin / (r / Math.sqrt(2))),
                    t.grpAxis.tickFormat(function(e) {
                        return c(e, i)
                    }),
                    t.svg.select("g.grp-axis").transition().duration(t.transDuration).style("font-size", r + "px").call(t.grpAxis),
                    t.onLabelClick && t.svg.selectAll("g.y-axis,g.grp-axis").selectAll("text").style("cursor", "pointer").on("click", function(n) {
                        var a = n.split("+&+");
                ...
                function() {
                    ...
                    n.append("title").text("click-drag to zoom in"),
                    (e = e.merge(n)).transition().duration(t.transDuration).attr("width", t.graphW).attr("height", function(e) {
                ...
                t.svg.select(".legendG").transition().duration(t.transDuration).attr("transform", "translate(".concat(t.leftMargin + .05 * t.graphW, ",2)")),
