...
mejs.HtmlMediaElementShim = {
    ...
    createPlugin: function(a, b, c, d, e, g) {
        ...
        var f = 1, h = 1, l = "me_" + a.method + "_" + mejs.meIndex++, j = new mejs.PluginMediaElement(l,a.method,a.url), k = document.createElement("div"), m;
        j.tagName = c.tagName;
    ...
    mejs.MediaElementPlayer.prototype = {
        ...
        buildkeyboard: function(a, b, c, d) {
            ...
            f(document).click(function(e) {
                if (f(e.target).closest(".mejs-container").length == 0)
                    a.hasFocus = false
            })
        },
        findTracks: function() {
            ...
            if (!(mejs.MediaFeatures.hasTouch && this.options.hideVolumeOnTouchDevices)) {
                var e = this.isVideo ? this.options.videoVolume : this.options.audioVolume
                  ...
                  , m = function(j) {
                    ...
                    l = Math.min(l, 1);
                    p(l);
                    l == 0 ? d.setMuted(true) : d.setMuted(false);
                    d.setVolume(l)
                }
                  , q = false
                  , i = false;
        ...
        buildfullscreen: function(a, b, c, d) {
            if (a.isVideo) {
                ...
                f(document).bind("keydown", function(i) {
                    if ((mejs.MediaFeatures.hasTrueNativeFullScreen && mejs.MediaFeatures.isFullScreen() || e.isFullScreen) && i.keyCode == 27)
                        a.exitFullScreen()
                })
            }
        },
        ...
        buildtracks: function(a, b, c, d) {
            if (a.isVideo)
                if (a.tracks.length != 0) {
                    ...
                    for (e = 0; e < a.tracks.length; e++)
                        a.tracks[e].kind == "subtitles" && a.addTrackButton(a.tracks[e].srclang, a.tracks[e].label);
                    a.loadNextTrack();
                    d.addEventListener("timeupdate", function() {
                        a.displayCaptions()
                    }, false);
...
(function(f) {
    ...
    f.extend(MediaElementPlayer.prototype, {
        ...
        renderContextMenu: function(a, b) {
            for (var c = this, d = "", e = c.options.contextMenuItems, g = 0, k = e.length; g < k; g++)
                if (e[g].isSeparator)
                    d += '<div class="mejs-contextmenu-separator"></div>';
                else {
                    var h = e[g].render(c);
                    if (h != null)
                        d += '<div class="mejs-contextmenu-item" data-itemindex="' + g + '" id="element-' + Math.random() * 1E6 + '">' + h + "</div>"
                }
